- dashboard: envases_74_bis
  ...
  - name: SUMMARY
    ...
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.sort_category2, rpt_alg.category2, rpt_alg.vacio_1, rpt_alg.vacio_2,
      rpt_alg.SALES_DAY, rpt_alg.TOTAL_AMOUNT_MTD, rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD,
      rpt_alg.TOTAL_AMOUNT_YTD, rpt_alg.VS_T_AMOUNT_YTD_LY, rpt_alg.VS_TOTAL_BUD_YTD]
    filters:
      rpt_alg.category: "-TOTAL MXN,-TOTAL EUR"
      rpt_alg.category2: "-NULL"
      rpt_alg.summary_flag: '1,2'
    sorts: [rpt_alg.sort_category2]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: false
    ...
    column_order: [rpt_alg.category2, rpt_alg.SALES_DAY, rpt_alg.vacio_1, rpt_alg.TOTAL_AMOUNT_MTD,
      rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD, rpt_alg.vacio_2, rpt_alg.TOTAL_AMOUNT_YTD,
      rpt_alg.VS_T_AMOUNT_YTD_LY, rpt_alg.VS_TOTAL_BUD_YTD]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 10
    series_labels:
      rpt_alg.SALES_DAY: SALES YESTERDAY
      rpt_alg.TOTAL_AMOUNT_MTD: TOTAL AMOUNT
      ...
      rpt_alg.TOTAL_AMOUNT_YTD: TOTAL AMOUNT
      ...
      rpt_alg.category2: COUNTRY
      rpt_alg.vacio_1: "."
      rpt_alg.vacio_2: "."
    series_column_widths:
      rpt_alg.TOTAL_AMOUNT_MTD_LY: 100
      rpt_alg.TOTAL_AMOUNT_YTD_LY: 100
      rpt_alg.vacio_1: 10
      rpt_alg.SALES_DAY: 70
      rpt_alg.TOTAL_AMOUNT_MTD: 70
      rpt_alg.VS_T_AMOUNT_MTD_LY: 70
      rpt_alg.VS_TOTAL_BUD_MTD: 70
      rpt_alg.TOTAL_AMOUNT_YTD: 70
      rpt_alg.VS_T_AMOUNT_YTD_LY: 70
      rpt_alg.VS_TOTAL_BUD_YTD: 70
      rpt_alg.category2: 120
      rpt_alg.vacio_2: 10
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rpt_alg.category_orden, rpt_alg.sort_category2]
    listen:
      Período: rpt_alg.date_filter
    row: 2
    col: 6
  ...
  - title: MEXICO
    ...
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      rpt_alg.TOTAL_QTY_MTD, rpt_alg.VS_T_QTY_MTD_LY, rpt_alg.VS_T_QTY_BUD_MTD, rpt_alg.TOTAL_AMOUNT_MTD,
      rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD, rpt_alg.TOTAL_AMOUNT_MTD_LY,
      rpt_alg.TOTAL_AMOUNT_BUD_MTD, rpt_alg.TOTAL_QTY_YTD, rpt_alg.VS_T_QTY_YTD_LY,
      ...
      rpt_alg.sort_category]
    filters:
      rpt_alg.category: "-TOTAL EUR,-SUB Europa,-SUB America"
      rpt_alg.cluster: MEXICO
    ...
    pinned_columns:
      rpt_alg.sort_category: left
      rpt_alg.category: left
    column_order: [rpt_alg.category, rpt_alg.SALES_DAY, rpt_alg.vacio_1, rpt_alg.vacio_3,
      rpt_alg.TOTAL_QTY_MTD, rpt_alg.VS_T_QTY_MTD_LY, rpt_alg.VS_T_QTY_BUD_MTD, rpt_alg.TOTAL_AMOUNT_MTD,
      rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD, rpt_alg.TOTAL_AMOUNT_MTD_LY,
  ...
  - title: USA
    ...
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      ...
      rpt_alg.sort_category]
    filters:
      rpt_alg.category: "-TOTAL MXN,-TOTAL EUR,-SUB Europa,-SUB America,-TOTAL LOCAL\
        \ CURRENCY USD"
      rpt_alg.cluster: USA
    sorts: [rpt_alg.sort_category]
    limit: 500
  ...
  - title: CANADA
    ...
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      ...
      rpt_alg.VS_TOTAL_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_YTD]
    filters:
      rpt_alg.category: "-TOTAL MXN,-TOTAL EUR,-SUB Europa,-SUB America"
      rpt_alg.cluster: CANADA
    sorts: [rpt_alg.category]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: false
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rpt_alg.category_orden]
    listen:
      Período: rpt_alg.date_filter
    row: 30
    col: 0
  ...
  - title: ECN - NORTH
    ...
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      ...
      rpt_alg.VS_T_QTY_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD, rpt_alg.VS_T_AMOUNT_YTD_LY,
      rpt_alg.VS_TOTAL_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_YTD,
      rpt_alg.sort_category_denmark]
    filters:
      rpt_alg.category: "-TOTAL MXN,-SUB Europa,-SUB America,-TOTAL USD"
      rpt_alg.cluster: ECN - NORTH
    sorts: [rpt_alg.sort_category_denmark]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: false
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rpt_alg.category_orden, rpt_alg.sort_category_denmark]
    listen:
      Período: rpt_alg.date_filter
    row: 43
    col: 0
  ...
  - title: TOTAL
    ...
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      ...
      rpt_alg.VS_TOTAL_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_YTD]
    filters:
      rpt_alg.category: TOTAL USD,TOTAL MXN
    sorts: [rpt_alg.category desc]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: false
  ...
  - title: TOTAL AMERICA
    ...
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.SALES_DAY,
      ...
      rpt_alg.VS_TOTAL_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_YTD]
    filters:
      rpt_alg.category: TOTAL MXN,TOTAL USD
      rpt_alg.cluster: GUATEMALA,CANADA,MEXICO,USA
    sorts: [rpt_alg.category desc]
    limit: 500
    column_limit: 50
    show_view_names: false
  ...
  - title: TOTAL EUROPE
    ...
    filters:
      rpt_alg.category: TOTAL MXN,TOTAL EUR
      rpt_alg.cluster: ECW - WEST,ECC - CENTRAL,ECN - NORTH,ECS - SOUTH,GUATEMALA
    sorts: [rpt_alg.category]
    limit: 500
    column_limit: 50
    show_view_names: false
